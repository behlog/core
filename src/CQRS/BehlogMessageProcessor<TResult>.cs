...
public class BehlogMessageProcessor<TMessage, TResponse> : IBehlogMessageProcessor<TMessage, TResponse> where TMessage : IBehlogMessage<TResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new ArgumentException($"No handler of signature {typeof(IBehlogMessageHandler<,>).Name} was " + 
                                            " found for {typeof(TMessage).Name}", typeof(TMessage).FullName);
        }
